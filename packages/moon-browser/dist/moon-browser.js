...
(function () {
	...
	var namesElementReferences = ["audio", "input", "textarea", "video"];
	/**
	 * Component names
	 */

	var names = namesMoon.concat(namesElement).concat(namesElementEmpty).concat(namesElementReferences);
	/**
	...
	function generate(tree) {
		...
		if (typeof tree === "string") {
			...
			for (var _i = 0; _i < value.length; _i++) {
				...
				var pairValue = pair[2];
				var pairValueGenerated = void 0;
				...
				_output += separator + "\"" + pairKey + "\":" + pairValueGenerated + generate(pair[3]);
				separator = ",";
			}
