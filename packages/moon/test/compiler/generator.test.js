...
test("generate dynamic element", () => {
	assertGenerate(
		...
		"if(ms[0]===undefined){ms[0]=[];ms[1]=m(1,\"text\",{\"\":\"test \"},[]);ms[2]={};ms[3]=m(0,\"h1\",{},[m(1,\"text\",{\"\":\"Test\"},[])]);ms[4]={};}return m(0,\"div\",ms[4],[ms[3],m(0,\"p\",ms[2],[ms[1],m(1,\"text\",{\"\":md.message},ms[0])])]);"
	);
});
...
test("generate static attributes", () => {
	assertGenerate(
		...
		"if(ms[0]===undefined){ms[0]=[];ms[1]=m(1,\"text\",{\"\":\"test \"},[]);ms[2]={};ms[3]=m(0,\"h1\",{\"id\":'bar',\"className\":'foo'},[m(1,\"text\",{\"\":\"Test\"},[])]);ms[4]={};}return m(0,\"div\",ms[4],[ms[3],m(0,\"p\",ms[2],[ms[1],m(1,\"text\",{\"\":md.message},ms[0])])]);"
	);
});
...
test("generate dynamic attributes", () => {
	assertGenerate(
		"<div><h1 id='bar' class={foo}>Test</h1><p>test {message}</p></div>",
		"if(ms[0]===undefined){ms[0]=[m(1,\"text\",{\"\":\"Test\"},[])];ms[1]=[];ms[2]=m(1,\"text\",{\"\":\"test \"},[]);ms[3]={};ms[4]={};}return m(0,\"div\",ms[4],[m(0,\"h1\",{\"id\":'bar',\"className\":md.foo},ms[0]),m(0,\"p\",ms[3],[ms[2],m(1,\"text\",{\"\":md.message},ms[1])])]);"
	);
});
...
test("generate events", () => {
	assertGenerate(
		...
		"if(ms[0]===undefined){ms[0]=[m(1,\"text\",{\"\":\"Test\"},[])];ms[1]=[];ms[2]=m(1,\"text\",{\"\":\"test \"},[]);ms[3]={};ms[4]={};}return m(0,\"div\",ms[4],[m(0,\"h1\",{\"id\":'bar',\"className\":md.foo,\"@click\":[md.doSomething,md,mc]},ms[0]),m(0,\"p\",ms[3],[ms[2],m(1,\"text\",{\"\":md.message},ms[1])])]);"
	);
});
...
test("generate dynamic components with children", () => {
	assertGenerate(
		...
		"if(ms[0]===undefined){ms[0]=[];ms[1]={};ms[2]={};}return m(0,\"div\",ms[2],[m(2,\"Component\",{\"foo\":md.bar,\"bar\":'baz'},[m(0,\"p\",ms[1],[m(1,\"text\",{\"\":md.message},ms[0])])])]);"
	);
});
...
test("generate if/else-if node", () => {
	assertGenerate(
		...
		"if(ms[0]===undefined){ms[0]=m(0,\"p\",{},[m(1,\"text\",{\"\":\"test\"},[])]);ms[1]=[];ms[2]=m(1,\"text\",{\"\":\"Dynamic: \"},[]);ms[3]={};ms[4]=m(1,\"text\",{\"\":\"\"},[]);ms[5]={};}var m0;if(md.condition){m0=ms[0];}else if(md.condition2){m0=m(0,\"h3\",ms[3],[ms[2],m(1,\"text\",{\"\":md.dynamic},ms[1])]);}else{m0=ms[4];}return m(0,\"div\",ms[5],[m0]);"
	);
});
...
test("generate if/else-if/else node", () => {
	assertGenerate(
		...
		"if(ms[0]===undefined){ms[0]=m(0,\"p\",{},[m(1,\"text\",{\"\":\"test\"},[])]);ms[1]=[];ms[2]=m(1,\"text\",{\"\":\"Dynamic: \"},[]);ms[3]={};ms[4]=[];ms[5]=m(0,\"h5\",{},[m(1,\"text\",{\"\":\"Ending\"},[])]);ms[6]={};}var m0;if(md.condition){m0=ms[0];}else if(md.condition2){m0=m(0,\"h3\",ms[3],[ms[2],m(1,\"text\",{\"\":md.dynamic},ms[1])]);}else{m0=m(1,\"text\",{\"\":md.dynamic},ms[4]);}return m(0,\"div\",ms[6],[m0,ms[5]]);"
	);
});
...
test("generate nested if/else-if/else node", () => {
	assertGenerate(
		...
		"if(ms[0]===undefined){ms[0]=m(0,\"p\",{},[m(1,\"text\",{\"\":\"test\"},[])]);ms[1]=m(1,\"text\",{\"\":\"\"},[]);ms[2]=[];ms[3]=m(1,\"text\",{\"\":\"Dynamic: \"},[]);ms[4]={};ms[5]=[];ms[6]={};ms[7]=[];ms[8]=m(0,\"p\",{},[m(1,\"text\",{\"\":\"test\"},[])]);ms[9]=[];ms[10]=m(1,\"text\",{\"\":\"Dynamic: \"},[]);ms[11]={};ms[12]=[];ms[13]=m(1,\"text\",{\"\":\"Dynamic: \"},[]);ms[14]={};ms[15]=[];ms[16]={};}var m0;if(md.condition){var m1;if(md.condition){var m2;if(md.nested){m2=ms[0];}else{m2=ms[1];}m1=m2;}else if(md.condition2){m1=m(0,\"h3\",ms[4],[ms[3],m(1,\"text\",{\"\":md.dynamic},ms[2])]);}else{m1=m(1,\"text\",{\"\":md.dynamic},ms[5]);}m0=m(0,\"p\",ms[6],[m1]);}else if(md.condition2){var m3;if(md.condition){m3=ms[8];}else if(md.condition2){m3=m(0,\"h3\",ms[11],[ms[10],m(1,\"text\",{\"\":md.dynamic},ms[9])]);}else{m3=m(1,\"text\",{\"\":md.dynamic},ms[12]);}m0=m(0,\"h3\",ms[14],[ms[13],m(1,\"text\",{\"\":md.dynamic},ms[7]),m3]);}else{m0=m(1,\"text\",{\"\":md.dynamic},ms[15]);}return m(0,\"div\",ms[16],[m0]);"
	);
});
...
test("generate for-of node", () => {
	assertGenerate(
		...
		"if(ms[0]===undefined){ms[0]=[];ms[1]={};ms[2]={};}var m0=[];for(var m1=0;m1<md.list.length;m1++){var $item=md.list[m1];m0.push(m(0,\"p\",ms[1],[m(1,\"text\",{\"\":$item},ms[0])]));}return m(0,\"span\",ms[2],m0);"
	);
});
...
test("generate for-of node with index", () => {
	assertGenerate(
		...
		"if(ms[0]===undefined){ms[0]=[];ms[1]=[];ms[2]={};ms[3]={};}var m0=[];for(var $index=0;$index<md.list.length;$index++){var $item=md.list[$index];m0.push(m(0,\"p\",ms[2],[m(1,\"text\",{\"\":$item},ms[0]),m(1,\"text\",{\"\":$index},ms[1])]));}return m(0,\"span\",ms[3],m0);"
	);
});
...
test("generate for-in node", () => {
	assertGenerate(
		...
		"if(ms[0]===undefined){ms[0]=[];ms[1]={};ms[2]={};}var m0=[];for(var $key in md.obj){m0.push(m(0,\"p\",ms[1],[m(1,\"text\",{\"\":$key},ms[0])]));}return m(0,\"span\",ms[2],m0);"
	);
});
...
test("generate for-in node with value", () => {
	assertGenerate(
		...
		"if(ms[0]===undefined){ms[0]=[];ms[1]=[];ms[2]={};ms[3]={};}var m0=[];for(var $key in md.obj){var $value=md.obj[$key];m0.push(m(0,\"p\",ms[2],[m(1,\"text\",{\"\":$key},ms[0]),m(1,\"text\",{\"\":$value},ms[1])]));}return m(0,\"span\",ms[3],m0);"
	);
});
...
test("generate nested for nodes", () => {
	assertGenerate(
		...
		"if(ms[0]===undefined){ms[0]=[];ms[1]=[];ms[2]=[];ms[3]=[];ms[4]={};ms[5]={};ms[6]={};}var m0=[];for(var $index=0;$index<md.list.length;$index++){var $item=md.list[$index];var m1=[];for(var $key in $item){var $value=$item[$key];m1.push(m(0,\"p\",ms[4],[m(1,\"text\",{\"\":$item},ms[0]),m(1,\"text\",{\"\":$index},ms[1]),m(1,\"text\",{\"\":$key},ms[2]),m(1,\"text\",{\"\":$value},ms[3])]));}m0.push(m(0,\"span\",ms[5],m1));}return m(0,\"span\",ms[6],m0);"
	);
});
...
test("generate for node with static custom element", () => {
	assertGenerate(
		...
		"if(ms[0]===undefined){ms[0]=[];ms[1]=[];ms[2]={};ms[3]={ custom: true };}var m0=[];for(var $index=0;$index<md.list.length;$index++){var $item=md.list[$index];m0.push(m(0,\"p\",ms[2],[m(1,\"text\",{\"\":$item},ms[0]),m(1,\"text\",{\"\":$index},ms[1])]));}return m(0,'h1',ms[3],m0);"
	);
});
...
test("generate for node with dynamic custom element", () => {
	assertGenerate(
		...
		"if(ms[0]===undefined){ms[0]=[];ms[1]=[];ms[2]={};}var m0=[];for(var $index=0;$index<md.list.length;$index++){var $item=md.list[$index];m0.push(m(0,\"p\",ms[2],[m(1,\"text\",{\"\":$item},ms[0]),m(1,\"text\",{\"\":$index},ms[1])]));}return m(0,'h1',{ custom: md.dynamic },m0);"
	);
});
