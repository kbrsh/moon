...
var ChildProcessPromise = function (_Promise) {
    ...
    function ChildProcessPromise(executor) {
        ...
        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ChildProcessPromise).call(this, function (_resolve, _reject) {
            resolve = _resolve;
            reject = _reject;
    ...
    _createClass(ChildProcessPromise, [{
        ...
        value: function then(onFulfilled, onRejected) {
            var newPromise = _get(Object.getPrototypeOf(ChildProcessPromise.prototype), 'then', this).call(this, onFulfilled, onRejected);
        ...
        value: function _catch(onRejected) {
            var newPromise = _get(Object.getPrototypeOf(ChildProcessPromise.prototype), 'catch', this).call(this, onRejected);
            newPromise.childProcess = this.childProcess;
            return newPromise;
        }
    }, {
