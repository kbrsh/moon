describe('Functional Component', function() {
    ...
    describe("Props", function() {
      ...
      Moon.component('functional-component-props', {
        ...
        props: ['someprop'],
        render: function(m, ctx) {
          return m("h1", {attrs: {}}, {shouldRender: true}, [m("#text", {shouldRender: true}, ctx.data.someprop)]);
        }
      });
    ...
    describe("Slots", function() {
      ...
      Moon.component('functional-component-slots', {
        functional: true,
        render: function(m, ctx) {
          return m("div", {attrs: {}}, {shouldRender: true}, [m("h1", {}, {shouldRender: true}, ctx.slots['default']), m("h1", {attrs: {}}, {shouldRender: true}, ctx.slots.named)]);
        }
      });
