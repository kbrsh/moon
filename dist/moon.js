...
(function (root, factory) {
  /* ======= Global Moon ======= */
  (typeof module === "undefined" ? "undefined" : _typeof(module)) === "object" && module.exports ? module.exports = factory() : root.Moon = factory();
})(undefined, function () {
  "use strict";
   ...
   */
  var createElement = function createElement(type, val, props, children, meta) {
    return {
      type: type,
      val: val,
      props: props,
  ...
  /* ======= Compiler ======= */
  var lex = function lex(input, opts) {
    var state = {
      input: input,
      current: 0,
      tokens: []
  ...
  var lexState = function lexState(state) {
  ...
  var lexText = function lexText(state) {
    var input = state.input;
    var len = input.length;
  ...
  var lexComment = function lexComment(state) {
    var input = state.input;
    var len = input.length;
    state.current += 4;
  ...
  var lexTag = function lexTag(state) {
    var input = state.input;
    var len = input.length;
  ...
  var lexTagType = function lexTagType(state) {
    var input = state.input;
    var len = input.length;
  ...
  var lexAttributes = function lexAttributes(state) {
    var input = state.input;
    var len = input.length;
  ...
  var createParseNode = function createParseNode(type, props, children) {
    return {
      type: type,
      props: props,
      children: children
  ...
  var generateEl = function generateEl(el) {
    var code = "";
    if (typeof el === "string") {
      code += "\"" + el + "\"";
    } else {
